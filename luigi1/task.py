...
from luigi1.task_register import Register, TaskClassException
...
def id_to_name_and_params(task_id):
    # DEPRECATED
    import luigi1.tools.parse_task
    return luigi1.tools.parse_task.id_to_name_and_params(task_id)
