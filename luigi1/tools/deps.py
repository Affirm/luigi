...
from luigi1.contrib.ssh import RemoteTarget
from luigi1.postgres import PostgresTarget
...
class UpstreamArg(luigi1.Task):

    'Used to provide the global parameter -- upstream'
    upstream = luigi1.Parameter(is_global=True, default=None)
