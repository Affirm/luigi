...
class SparkSubmitTask(luigi1.Task):
    """
...
class SparkJob(luigi1.Task):
    ...
    queue = luigi1.Parameter(is_global=True, default=None, significant=False)
    ...
    def input(self):
        return luigi1.task.getpaths(self.requires())
    ...
    def run(self):
        ...
        tmp_output = luigi1.hdfs.HdfsTarget(path_no_slash + '-luigi-tmp-%09d' % random.randrange(0, 1e10))
