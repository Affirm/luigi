...
import luigi1
from luigi1 import postgres
from luigi1.contrib import rdbms
from luigi1.s3 import S3PathTask, S3Target
...
class RedshiftTarget(postgres.PostgresTarget):
    ...
    """
    marker_table = luigi1.configuration.get_config().get(
        'redshift',
        'marker-table',
        'table_updates')
...
class KillOpenRedshiftSessions(luigi1.Task):
    """
    ...
    connection_reset_wait_seconds = luigi1.IntParameter(default=60)
