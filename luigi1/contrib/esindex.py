...
class ElasticsearchTarget(luigi1.Target):
    """ Target for a resource in Elasticsearch."""

    marker_index = luigi1.configuration.get_config().get('elasticsearch',
                                                        'marker-index', 'update_log')
    marker_doc_type = luigi1.configuration.get_config().get('elasticsearch',
                                                           'marker-doc-type', 'entry')
