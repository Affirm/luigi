...
class ScaldingJobRunner(luigi1.hadoop.JobRunner):
    """
    ...
    def get_scalding_core(self):
        ...
        for j in os.listdir(lib_dir):
            if j.startswith('scalding-core-'):
                ...
                return p
        raise luigi1.hadoop.HadoopJobError('Coudl not find scalding-core.')
    ...
    def get_job_class(self, source):
        ...
        if job_class:
            ...
            raise luigi1.hadoop.HadoopJobError('Coudl not find scalding job class.')
    ...
    def run_job(self, job):
        ...
        arglist = luigi1.hdfs.load_hadoop_cmd() + ['jar', scalding_core, '-libjars', libjars]
        ...
        (tmp_files, job_args) = luigi1.hadoop_jar.fix_paths(job)
        arglist += job_args
        ...
        luigi1.hadoop.run_and_track_hadoop_job(arglist, env=env)

        for a, b in tmp_files:
            a.move(b)


class ScaldingJobTask(luigi1.hadoop.BaseHadoopJobTask):
    """
