...
class SQLAlchemyTarget(luigi1.Target):
    """
    ...
    def create_marker_table(self):
        ...
        if self.marker_table is None:
            self.marker_table = luigi1.configuration.get_config().get('sqlalchemy', 'marker-table', 'table_updates')
